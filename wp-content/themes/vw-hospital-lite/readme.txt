...
= 2.2.2 =
  -- Added show /hide blog page border,border color and border width setting.
  -- Changed category text styling in single post.
...
= 2.2.6 =
  -- Resolved sidebar error.
  -- Resolved activation notice dismiss issue.
  -- Resolved getstarted responsive error.
...
*   Stocksnap Images
  ...
  Slider image, Copyright Oles kanebckuu
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/hospital-medical-GZWA3OWENX

  Slider image, Copyright Oles kanebckuu
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/doctor-patient-WY8KTJHDJZ
